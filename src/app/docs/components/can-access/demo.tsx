    ...
    <ProfileContext.Provider value={mockContextValue}>
      <div className="flex flex-col gap-4 p-4 border rounded-lg">
        <div className="flex flex-col gap-2">
            <h4 className="text-sm font-medium">Permiso Concedido (marketing:campaigns:create)</h4>
            <CanAccess
                subdomain="marketing"
                resource="campaigns"
                action="create"
        ...
        <div className="flex flex-col gap-2">
            <h4 className="text-sm font-medium">Permiso Denegado (marketing:campaigns:update) - Variant: disabled</h4>
            <CanAccess
                subdomain="marketing"
                resource="campaigns"
                action="update"
