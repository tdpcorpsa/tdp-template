...
export default function ConfirmAlertDemo() {
  ...
  const handleAction = (action: string) => {
    setLastAction(
      `Acción ejecutada: ${action} - ${new Date().toLocaleTimeString()}`
    )
  }
    ...
    <div className="container mx-auto py-8 space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Componente reutilizable para confirmaciones de acciones importantes
          que requieren escribir una palabra de confirmación.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <h2 className="text-2xl font-semibold">
            2. Diferentes Palabras de Confirmación
          </h2>
          <p className="text-muted-foreground">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-muted p-4 rounded-lg space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <li>
              Botón de confirmar deshabilitado hasta que la palabra coincida
            </li>
            ...
            <li>
              Indicador visual cuando la palabra es correcta (borde verde)
            </li>
          </ul>
        </div>
        ...
        <div className="bg-muted p-4 rounded-lg space-y-2">
          ...
          <div className="text-sm font-mono space-y-1">
            <div>
              <span className="text-blue-600">confirmWord</span>: string -
              Palabra que debe escribir el usuario
            </div>
            <div>
              <span className="text-blue-600">onConfirm</span>: () =&gt; void -
              Callback al confirmar
            </div>
            <div>
              <span className="text-blue-600">title</span>?: string - Título del
              modal
            </div>
            <div>
              <span className="text-blue-600">description</span>?: string -
              Descripción de la acción
            </div>
            <div>
              <span className="text-blue-600">variant</span>?: "default" |
              "destructive" - Estilo del botón trigger
            </div>
          </div>
        </div>
      </div>
